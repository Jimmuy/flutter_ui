...
class LoadingButtonState extends State<LoadingButton> {
  late ValueNotifier<bool> _enableNotifier;
  ...
  Widget _configCenterWidget() {
    var imagesAnimation = ImagesAnimation(
      w: 24,
      h: 24,
      entry: ImagesAnimationEntry(0, 29, widget.isLightStyle ? 'images/ym_common_comp_%s_light.png' : 'images/ym_common_comp_%s.png'),
    );

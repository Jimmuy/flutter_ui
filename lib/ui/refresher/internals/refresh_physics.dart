...
//    print('findViewport $result');
  ...
  bool shouldAcceptUserOffset(ScrollMetrics position) {
    ...
    if (controller.headerMode.value == RefreshStatus.twoLeveling && !enableScrollWhenTwoLevel) {
      return false;
    }
    // enableScrollWhenRefreshCompleted
        ...
        (!enableScrollWhenRefreshCompleted &&
            position.pixels < 0 &&
            !(viewportRender?.firstChild as RenderSliverRefresh).hasLayoutExtent &&
            (controller.headerMode.value == RefreshStatus.completed || controller.headerMode.value == RefreshStatus.failed))) {
      return false;
